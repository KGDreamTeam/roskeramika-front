  ...
  switch (action.type) {
    ...
    case actionTypes/* RE_SET_FILTERS */.Rx:
      ...
      for (let i of state.size) {
        sizeReseted.push(filters_objectSpread(filters_objectSpread({}, i), {}, {
          checked: false
        }));
      }

      for (let i of state.usage) {
        usageReseted.push(filters_objectSpread(filters_objectSpread({}, i), {}, {
          checked: false
        }));
      }

      for (let i of state.surface) {
        surfaceReseted.push(filters_objectSpread(filters_objectSpread({}, i), {}, {
          checked: false
        }));
      }

      for (let i of state.catalog) {
        catalogReseted.push(filters_objectSpread(filters_objectSpread({}, i), {}, {
          checked: false
        }));
      }
...
;// CONCATENATED MODULE: ./src/assets/img/ic_design.js
...
const IcDesignIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)("g", {
      clipPath: "url(#clip0)",
      children: [/*#__PURE__*/jsx_runtime_.jsx("path", {
        d: "M21.2361 16.937C21.1045 16.8824 20.953 16.9126 20.8522 17.0133L17.0026 20.863C16.9018 20.9638 16.8717 21.1153 16.9263 21.2469C16.9807 21.3786 17.1093 21.4644 17.2517 21.4644H21.1014C21.296 21.4644 21.4536 21.3067 21.4536 21.1121V17.2624C21.4536 17.12 21.3678 16.9915 21.2361 16.937ZM18.102 20.7599L20.749 18.1129V20.7599H18.102Z",
        fill: "black"
      }), /*#__PURE__*/jsx_runtime_.jsx("path", {
        d: "M23.7826 11.2907C23.651 11.2361 23.4995 11.2663 23.3987 11.367L22.3437 12.422V5.24867C22.3437 5.05409 22.1859 4.8964 21.9914 4.8964H19.2848L20.2673 3.9139C20.2674 3.91376 20.2676 3.91357 20.2677 3.91343L21.2144 2.96674C21.4172 2.76391 21.5289 2.4941 21.5289 2.20722C21.5289 1.92035 21.4172 1.65063 21.2144 1.44771L20.1197 0.352984C19.9169 0.150155 19.647 0.0384521 19.3602 0.0384521C19.0733 0.0384521 18.8035 0.150155 18.6006 0.352984L17.6535 1.30014L16.509 2.44464L14.0573 4.89635H3.12282V1.41142C3.12282 1.21685 2.96508 1.05916 2.77055 1.05916C1.24289 1.05925 0 2.30205 0 3.8298V18.7917C0 18.8177 0.00300001 18.843 0.00834377 18.8674C0.0570001 19.5156 0.337454 20.1179 0.806158 20.5751C1.30716 21.0638 1.96852 21.3329 2.66846 21.3329H13.4328L11.4055 23.3602C11.3047 23.461 11.2746 23.6124 11.3291 23.7441C11.3836 23.8757 11.5121 23.9615 11.6546 23.9615H23.6478C23.8423 23.9615 24 23.8038 24 23.6093V11.6161C24 11.4737 23.9142 11.3452 23.7826 11.2907ZM19.0989 0.851219C19.2429 0.707125 19.4775 0.707125 19.6215 0.851219L20.7163 1.94599C20.8604 2.09003 20.8604 2.32455 20.7163 2.46864L20.0183 3.16671L18.4008 1.54928L19.0989 0.851219ZM17.9026 2.04747L19.5201 3.66485L18.8737 4.31121L17.2564 2.69383L17.9026 2.04747ZM23.2956 15.5744H22.6457C22.4511 15.5744 22.2934 15.732 22.2934 15.9266C22.2934 16.1212 22.4511 16.2789 22
4525 5.49753L16.7581 3.19197L18.3754 4.8094L18.1857 4.99915C18.1855 4.99929 18.1853 4.99943 18.1852 4.99957L11.0823 12.1026L9.46493 10.4852L10.865 9.08511C11.0026 8.94748 11.0026 8.7245 10.865 8.58692C10.7274 8.44939 10.5044 8.44939 10.3668 8.58692L8.71764 10.2361C8.70883 10.2449 8.70058 10.2542 8.69285 10.2638C8.69027 10.267 8.68797 10.2704 8.68553 10.2737C8.68056 10.2803 8.67569 10.287 8.67114 10.2939C8.66856 10.298 8.66622 10.3021 8.66378 10.3063C8.65989 10.3128 8.65614 10.3195 8.65272 10.3263C8.65047 10.3307 8.64845 10.3351 8.64639 10.3397C8.64325 10.3466 8.64035 10.3536 8.63767 10.3607C8.63674 10.3632 8.63552 10.3655 8.63463 10.368L7.94833 12.3121L7.48042 13.6377C7.47423 13.6553 7.46978 13.6732 7.46645 13.6913H6.29495C6.10042 13.6913 5.94268 13.849 5.94268 14.0436C5.94268 14.2381 6.10042 14.3958 6.29495 14.3958H16.0503C16.2449 14.3958 16.4026 14.2381 16.4026 14.0436C16.4026 13.849 16.2449 13.6913 16.0503 13.6913H9.05125L11.1995 12.9329C11.2013 12.9323 11.203 12.9314 11.2048 12.9307C11.2131 12.9276 11.2213 12.9242 11.2294 12.9205C11.2327 12.919 11.2359 12.9176 11.2391 12.916C11.2475 12.9118 11.2558 12.9072 11.2639 12.9022C11.2666 12.9006 11.2693 12.8991 11.2719 12.8975C11.2804 12.8921 11.2886 12.8861 11.2967 12.8798C11.2987 12.8783 11.3008 12.8769 11.3028 12.8753C11.3126 12.8675 11.3222 12.859 11.3313 12.8499L18.5803 5.60098H21.6391V13.1266L16.6002 18.1655C16.4626 18.3031 16.4626 18.5261 16.6002 18.6637C16.6088 18.6723 16.6177 18.6803 16.627 18.6879C16.6916 18.7405 16.7705 18.7669 16.8493 18.7669C16.9281 18.7669 17.0071 18.7405 17.0716 18.6879C17.0809 18.6804 17.0898 18.6723 17.0984 18.6637C17.0985 18.6636 17.0984 18.6637 17.0985 18.6636L23.2956 12.4664V15.5744ZM10.438 12.4545L9.42897 12.8107L8.75669 12.1385L9.11289 11.1294L10.438 12.4545Z",
        fill: "black"
      })]
...
const UpperHeader = () => {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      ...
      }), /*#__PURE__*/jsx_runtime_.jsx(containers_Search, {}), width > 770 ? /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
        className: "design",
        children: [/*#__PURE__*/jsx_runtime_.jsx(IcDesignIcon, {
          className: "ic-design"
        }), "\u0417\u0430\u043A\u0430\u0437\u0430\u0442\u044C \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u044B\u0439 \u0434\u0438\u0437\u0430\u0439\u043D"]
      }) : null, /*#__PURE__*/jsx_runtime_.jsx(containers_Basket, {})]
    })
  });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [664,413,231,680], () => (__webpack_exec__(2700)));
